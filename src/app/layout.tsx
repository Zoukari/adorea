...
export const metadata: Metadata = {
  ...
  keywords: ['PMU Djibouti', 'Sourcils PMU Djibouti', 'Candy Lips Djibouti', 'Makeup Pro Djibouti', 'Nail Artist Djibouti', 'ADORÉA'],
  openGraph: {
  ...
  return (
    <html lang="fr">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;1,300;1,400&family=Montserrat:wght@200;300;400;500&family=Manrope:wght@300;400;500&display=swap"
          rel="stylesheet"
        />
        <script
